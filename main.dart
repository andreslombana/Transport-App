...
import 'package:indriver_clone_flutter/src/presentation/utils/PushNotificationsService.dart';
...
// Global Key para la navegación sin contexto (usada por las notificaciones push)
...
void main() async {
  ...
  // Intentamos inicializar. Si falla porque ya existe, capturamos el error y seguimos.
  try {
    await Firebase.initializeApp(
      options: DefaultFirebaseOptions.currentPlatform,
    );
  } catch (e) {
    print("Nota: Firebase ya estaba inicializado (Error controlado): $e");
  }
  // ------------------------------------
  ...
  // Configurar Canales de Notificación (Solo móvil)
  if (!kIsWeb) {
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    // Activar Listener de Mensajes en Primer Plano
    onMessageListener();
  }
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        navigatorKey: navigatorKey, // Asignar la key global para navegación
