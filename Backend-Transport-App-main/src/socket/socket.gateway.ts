...
export class SocketGateway implements OnGatewayConnection, OnGatewayDisconnect {
    ...
    handleNewDriverAssigned(@ConnectedSocket() client: Socket, @MessageBody() data: any) {
        // IMPORTANTE: El nombre del evento debe coincidir con lo que escucha el conductor
        // Usualmente el conductor escucha en su propio canal o en un canal general
