...
@LazySingleton(as: ClientRequestsRepository)
class ClientRequestsRepositoryImpl implements ClientRequestsRepository {
  ...
  @override
  Future<Resource<bool>> cancelRequest(int idClientRequest) {
    return clientRequestsService.cancelRequest(idClientRequest);
  }
