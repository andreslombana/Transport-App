...
class OnClientRequestReceived extends DriverMapLocationEvent {
  final int idClientRequest; // O String, dependiendo de tu BD. Usualmente es int en Postgres/MySQL
  OnClientRequestReceived({required this.idClientRequest});
}