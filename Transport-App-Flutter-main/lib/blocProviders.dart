...
List<BlocProvider> blocProviders = [
  ...
  BlocProvider<DriverClientRequestsBloc>(create: (context) => DriverClientRequestsBloc(blocSocketIO: context.read<BlocSocketIO>(),clientRequestsUseCases: locator<ClientRequestsUseCases>(),driversPositionUseCases: locator<DriversPositionUseCases>(),authUseCases: locator<AuthUseCases>(),driverTripRequestUseCases: locator<DriverTripRequestUseCases>(),),),
