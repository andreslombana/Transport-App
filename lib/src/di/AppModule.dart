...
// YA NO IMPORTAMOS LOS USECASES DE CLIENT REQUESTS AQUÍ
...
abstract class AppModule {
  ...
  // --- AQUÍ BORRAMOS ClientRequestsUseCases ---
  // Ya tiene @injectable en su propio archivo, así que Injectable
  // lo encontrará y lo registrará automáticamente.
  // --------------------------------------------
